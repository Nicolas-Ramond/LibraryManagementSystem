...
class UserFixtures extends Fixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user->setLastName('Ramond');
        $user->setEmail('nicolas.ramond@me.com');
        $user->setRoles([User::ROLE_SUPER_ADMIN, User::ROLE_ADMIN, User::ROLE_LIBRARIAN, User::ROLE_MEMBER]);
        $encoded = $this->encoder->encodePassword($user, 'eiuaeiua');
        ...
        $encoded = $this->encoder->encodePassword($superAdmin, 'eiuaeiua');
        ...
        $encoded = $this->encoder->encodePassword($admin, 'eiuaeiua');
        ...
        $encoded = $this->encoder->encodePassword($librarian, 'eiuaeiua');
        $librarian->setLibrary($libraries[rand(1, 3) ]);
        ...
        $encoded = $this->encoder->encodePassword($member, 'eiuaeiua');
